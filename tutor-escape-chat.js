(function () {
  ...
  var shortHints = {
    ...
    hemorr: 'homeostase-integrada-tricompartimental.html',
    osmo: 'osmose-equilibrio-hidroeletrolitico.html',
    tonic: 'osmose-equilibrio-hidroeletrolitico.html',
    starling: 'homeostase-integrada-tricompartimental.html',
    vent: 'ventilacao-pulmonar.html',
    folego: 'ventilacao-pulmonar.html',
    retorno: 'retorno-venoso.html',
    loop: 'loop-cardiaco-funcional.html',
    sarcom: 'contracao-muscular-esqueletica.html',
    placa: 'contracao-muscular-sarcomero.html',
