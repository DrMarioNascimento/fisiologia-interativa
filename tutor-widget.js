(function () {
  ...
  const aliases = {
    ...
    'contracao-muscular-esqueletica.html': 'calcio ca2 troponina tropomiosina atp pi ponte cruzada golpe de forca zona h banda i banda a relaxamento serca tetano abalo rigor dantroleno miastenia contracao musculo',
    'acoplamento-excitacao-contracao.html': 'tubulo t reticulo sarcoplasmatico ryr calcio excitação contração',
    'contracao-muscular-sarcomero.html': 'sarcômero musculo fasciculo fibra miofibrila filamento actina miosina placa motora acetilcolina ach acetilcolinesterase tubulo t dhpr ryr1 calcio deslizamento',
    'osmose-equilibrio-hidroeletrolitico.html': 'osmose osmolalidade osmolaridade tonicidade isotonico hipotonico hipertonico lic lec agua celula incha retrai ureia sodio hiponatremia hipernatremia soro fisiologico nacl sg 5',
    'homeostase-integrada-tricompartimental.html': 'homeostase plasma intersticio lic compartimentos starling edema pressao oncotica potencial de membrana potassio hipercalemia rim adh sede sal hemorragia sudorese desidratacao diarreia vomito',
    'loop-cardiaco-funcional.html': 'loop pressao volume pv sistole diastole valva mitral aortica isovolumetrica ejecao enchimento vdf vsf volume sistolico fracao de ejecao debito cardiaco pre carga pos carga contratilidade frank starling',
